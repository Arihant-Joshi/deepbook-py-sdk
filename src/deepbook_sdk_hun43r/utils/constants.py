...
SuiBlockchainType = Dict[str, str]
DeepbookPackageIds = Dict[str, dict]
CoinMap = Dict[str, dict]
PoolMap = Dict[str, dict]

suiURL_regex: SuiBlockchainType = {
    "testnet": "^(http[s]{0,1}://){0,1}testnet.mystenlabs.com/.*$",
    "mainnet": "^(http[s]{0,1}://){0,1}mainnet.suiblockchain.com/.*$"
}

deepbookPackageIds: DeepbookPackageIds = {
    "testnet": {
